...
describe("Day 4 - Part 2", ()=> {
    ...
    it("passing a series of 4 valid passports should return 4",()=>{
        assert.strictEqual(two(validPassports), 4);
    });
    it("passing a series of 4 invalid passports should return 0",()=>{
        assert.strictEqual(two(invalidPassports), 0);
    });
});